...
class TestArrowBroadcastingPerformance:
    ...
    def test_broadcasting_vs_full_array(self, benchmark, size):
        ...
        result = benchmark(arrow_native.arrow_call_price, spots, strikes_scalar, times, rates, sigmas)
...
class TestArrowGreeksPerformance:
    ...
    def test_greeks_broadcasting(self, benchmark, size):
        ...
        # Benchmark Greeks
        result = benchmark(arrow_native.arrow_greeks, spots, strikes, times, rates, sigmas, True)
...
class TestBlack76Broadcasting:
    ...
    def test_black76_broadcasting(self, benchmark, size):
        ...
        result = benchmark(arrow_native.arrow76_call_price, forwards, strikes, times, rates, sigmas)
    ...
    def test_black76_greeks(self, benchmark, size):
        ...
        result = benchmark(arrow_native.arrow76_greeks, forwards, strikes, times, rates, sigmas, True)
...
class TestMemoryEfficiency:
    ...
    def test_memory_usage_comparison(self):
        ...
        result1 = arrow_native.arrow_call_price(spots, strikes_scalar, times_scalar, rates_scalar, sigmas_scalar)
        ...
        result2 = arrow_native.arrow_call_price(spots, strikes_full, times_full, rates_full, sigmas_full)
