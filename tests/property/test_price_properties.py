...
class TestPriceProperties:
    ...
    def test_volatility_monotonicity(self, s: float, k: float, t: float, r: float, sigma1: float, sigma2: float) -> None:
        ...
        price1 = calculate_call_price(s, k, t, r, sigma1)
        price2 = calculate_call_price(s, k, t, r, sigma2)
    ...
    def test_time_monotonicity(self, s: float, k: float, t1: float, t2: float, r: float, sigma: float) -> None:
        ...
        price1 = calculate_call_price(s, k, t1, r, sigma)
        price2 = calculate_call_price(s, k, t2, r, sigma)
    ...
    def test_strike_monotonicity(self, s: float, k1: float, k2: float, t: float, r: float, sigma: float) -> None:
        ...
        price1 = calculate_call_price(s, k1, t, r, sigma)
        price2 = calculate_call_price(s, k2, t, r, sigma)
    ...
    def test_delta_bounds(self, s1: float, s2: float, k: float, t: float, r: float, sigma: float) -> None:
        ...
        price1 = calculate_call_price(s1, k, t, r, sigma)
        price2 = calculate_call_price(s2, k, t, r, sigma)
    ...
    def test_convexity(self, s: float, k: float, t: float, r: float, sigma: float) -> None:
        ...
        price_low = calculate_call_price(s_low, k, t, r, sigma)
        price_mid = calculate_call_price(s_mid, k, t, r, sigma)
        price_high = calculate_call_price(s_high, k, t, r, sigma)
    ...
    def test_interest_rate_monotonicity(self, s: float, k: float, t: float, r1: float, r2: float, sigma: float) -> None:
        ...
        price1 = calculate_call_price(s, k, t, r1, sigma)
        price2 = calculate_call_price(s, k, t, r2, sigma)
...
class TestBatchProperties:
    ...
    def test_batch_consistency(self, spots: list[float], k: float, t: float, r: float, sigma: float) -> None:
        ...
        # バッチ処理
        batch_prices = calculate_call_price_batch(spots_array, k, t, r, sigma)

        # 個別処理との比較
        for i, spot in enumerate(spots):
            single_price = calculate_call_price(spot, k, t, r, sigma)
    ...
    def test_batch_ordering(
        ...
        prices = calculate_call_price_batch(spots, k, t, r, sigma=0.2)
...
class TestNumericalStability:
    ...
    def test_scale_invariance(self, scale: float, k: float, t: float, r: float, sigma: float) -> None:
        """スケール不変性のテスト."""
        # 基準価格
        base_price = calculate_call_price(100.0, k, t, r, sigma)
        ...
        # スケール後の価格
        scaled_price = calculate_call_price(scaled_s, scaled_k, t, r, sigma)
