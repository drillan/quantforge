...
class TestBroadcasting:
    ...
    def test_single_element_array_vs_scalar(self):
        ...
        result_array = bs.call_price_batch(
            spots=single_array,
            strikes=105.0,
            times=1.0,
            rates=0.05,
        ...
        # Pure scalar
        result_scalar = bs.call_price_batch(
            spots=100.0,
            strikes=105.0,
            times=1.0,
            rates=0.05,
    ...
    def test_no_validation_functions(self):
        ...
        regular_result = bs.call_price_batch(
            spots=spots,
            strikes=105.0,
            times=1.0,
            rates=0.05,
        ...
        for no_val, regular in zip(results_no_val, results_regular):
