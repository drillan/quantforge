...
def analyze_performance_trends() -> dict[str, Any]:
    """パフォーマンストレンドを分析."""
    from benchmarks.save_results import load_history
    ...
    trends = {"timestamp": latest["timestamp"], "comparisons": {}, "regressions": [], "improvements": []}
...
def generate_summary_table() -> str:
    ...
    if "single" in data:
        ...
        for impl, name in [("quantforge", "QuantForge"), ("pure_python", "Pure Python"), ("scipy", "SciPy")]:
