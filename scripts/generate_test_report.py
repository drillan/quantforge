...
- **MyPy**: {'✅ Type Safe' if os.path.exists('mypy_results.txt') and 'Success' in open('mypy_results.txt').read() if os.path.exists('mypy_results.txt') else False else '⚠️ Type Issues'}
...
"""
    ...
    print(f"JSON results saved: test_results.json")
